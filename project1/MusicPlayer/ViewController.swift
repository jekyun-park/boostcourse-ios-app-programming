...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func initializePlayer() {
        ...
        do {
            ...
            self.player.delegate = self // 뷰 컨트롤러의 인스턴스가 AVAudioPlayer의 델리게이트로 역할을 수행하겠다
    ...
    // timelabel의 text를 업데이트한다. 00:00:00 단위로 업데이트한다.
    ...
    func addTimeLabel() {
        ...
        // timeLabel의 centerX를 playPauseButton의 centerX와 맞춤
    ...
    func addProgressSlider() {
        ...
        let top: NSLayoutConstraint
        top = slider.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: 8)
...
//        self.addViewWithCode()
    ...
    // playPauseButton 터치시에 player가 멈춤 / 타이머 종료
